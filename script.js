...
function generiereKarten(spielerDaten) {
    ...
    spielerDaten.forEach(spieler => {
        // Hier greifen die 2 Stellen nach dem Komma (.toFixed(2))
        ...
        card.innerHTML = `
            ...
            <div class="stats-grid">
                <div>
                    ...
                    <div class="label" style="margin-top: 10px;">Bilanz (G : V)</div>
                    <div class="value-big">
                        <span class="bilanz-gewonnen">${spieler.siege}</span> : 
                        <span class="bilanz-verloren">${spieler.niederlagen}</span>
                    </div>
                    
                    <div class="label" style="margin-top: 10px;">Win-Rate (${winQuote}%)</div>
                ...
                <div>
                    ...
                    <div class="label" style="margin-top: 10px;">Legs (Gew : Verl)</div>
                    <div class="value-big">${spieler.legsGew} : ${spieler.legsVerl}</div>
                    
                    <div class="label" style="margin-top: 10px;">Leg-Rate (${legQuote}%)</div>
                    <div class="progress-bg">
