...
function renderSpieltag(daten, n_spieltag) {
    ...
    // Holt das Gesamtergebnis aus den globalen Spieltagsdaten für diesen Spieltag
    const passendesSpiel = spieltageDatenGlobal.find(z => z.spieltag == n_spieltag);
    const endergebnisText = (passendesSpiel && passendesSpiel.endergebnis) ? ` (${passendesSpiel.endergebnis})` : '';
